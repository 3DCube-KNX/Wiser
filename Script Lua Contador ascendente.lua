-- Obtenemos el valor de la dirección 1/0/0 y se asigna a la variable
...
-- Si el valor de la variable alcanza el máximo valor de 255, entonces no lo incrementamos	
